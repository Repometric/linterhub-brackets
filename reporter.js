...
define(function (require /*, exports, module*/) {
    ...
    Reporter.prototype.addGutterMarks = function(message, token) {
        ...
        if (message.type === "error") {
            mark.gutterMark.element.addClass("repometric-linterhub" + "-gutter-errors");
        }
    };
    ...
    Reporter.prototype.addLineMarks = function (message, token) {
        ...
        // Add line marks
        mark.lineMarks.push({
            line: this.cm.markText(token.start, token.end, {className: "repometric-linterhub" + "-" + message.type}),
            message: message
        });
    };
    ...
    Reporter.prototype.clearMarks = function () {
        ...
        this.cm.clearGutter("repometric-linterhub" + "-gutter");
